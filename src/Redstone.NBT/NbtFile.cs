...
namespace Redstone.NBT
{
    ...
    public sealed class NbtFile
    {
        ...
        /// </summary>
        public const int WriteBufferSize = 8 * 1024;
        ...
        /// <summary>
        /// Gets the Zlib message when the header is wrong.
        /// </summary>
        private static readonly string _wrongZLibHeaderMessage = "Unrecognized ZLib header. Expected 0x78";
        ...
        /// <summary> 
        /// Creates an empty <see cref="NbtFile"/> instance. 
        ...
        /// <summary>
        /// Creates a new <see cref="NbtFile"/> with the given root tag.
        /// </summary>
        ...
        public long LoadFromStream(Stream stream, NbtCompression compression, TagSelector selector)
        {
            ...
            switch (FileCompression)
            {
                ...
                case NbtCompression.ZLib:
                    ...
                    {
                        throw new InvalidDataException(_wrongZLibHeaderMessage);
                    }
                    stream.ReadByte();
                ...
                default:
                    throw new ArgumentOutOfRangeException(nameof(FileCompression));
            }
        ...
        public static string ReadRootTagName(Stream stream, NbtCompression compression, bool bigEndian, int bufferSize)
        {
            ...
            switch (compression)
            {
                ...
                default: throw new ArgumentOutOfRangeException(nameof(compression));
            }
        }
