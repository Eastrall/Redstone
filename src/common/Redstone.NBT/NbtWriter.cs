...
namespace Redstone.NBT
{
    ...
    public sealed class NbtWriter
    {
        ...
        /// No more tags can be written -OR- a named compound tag was expected -OR- a tag of a different type 
        /// was expected the size of a parent list has been exceeded.
        /// </exception>
        ...
        /// <paramref name="size"/>is negative -OR- <paramref name="elementType"/>is not a valid NbtTagType.
        /// </exception>
        ...
        /// <exception cref="NbtFormatException">
        /// No more tags can be written -OR- a named byte tag was expected -OR- a tag of a different type was expected -OR-
        ...
        /// <exception cref="NbtFormatException">
        /// No more tags can be written -OR- a named double tag was expected -OR- a tag of a different type was expected -OR-
        /// the size of a parent list has been exceeded.
        /// </exception>
        ...
        /// <exception cref="NbtFormatException">
        /// No more tags can be written -OR- a named int tag was expected -OR- a tag of a different type was expected -OR-
        /// the size of a parent list has been exceeded.
        /// </exception>
        ...
        /// <exception cref="NbtFormatException">
        /// No more tags can be written -OR- a named long tag was expected -OR- a tag of a different type was expected -OR-
        /// the size of a parent list has been exceeded.
        /// </exception>
        ...
        /// <exception cref="NbtFormatException">
        /// No more tags can be written -OR- a named short tag was expected -OR- a tag of a different type was expected -OR-
        /// the size of a parent list has been exceeded.
        /// </exception>
        ...
        /// <exception cref="NbtFormatException">
        /// No more tags can be written -OR- a named string tag was expected -OR- a tag of a different type was expected -OR-
        /// the size of a parent list has been exceeded.
        /// </exception>
        ...
        /// <exception cref="NbtFormatException">
        /// No more tags can be written -OR- a named byte array tag was expected -OR- a tag of a different type was expected -OR-
        /// the size of a parent list has been exceeded.
        /// </exception>
        ...
        /// <paramref name="count"/> is greater than <paramref name="offset"/>subtracted from the array length.
        /// </exception>
        ...
        /// </exception>
        /// <exception cref="ArgumentNullException"><paramref name="tagName"/> or <paramref name="data"/>is null.</exception>
        ...
        /// <param name="offset">The starting point in <paramref name="data"/>at which to begin writing. Must not be negative.</param>
        /// <param name="count">The number of bytes to write. Must not be negative.</param>
        /// <exception cref="NbtFormatException">No more tags can be written -OR- an unnamed byte array tag was expected -OR- a tag of a different type was expected.</exception>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="offset"/> or <paramref name="count"/>is negative.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="tagName"/> or <paramref name="data"/>is null.</exception>
        /// <exception cref="ArgumentException"><paramref name="count"/> is greater than <paramref name="offset"/>subtracted from the array length.</exception>
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="count"/>is negative.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="dataSource"/>is null.</exception>
        /// <exception cref="ArgumentException">Given stream does not support reading -OR- <paramref name="buffer"/>size is 0.</exception>
        ...
        /// <exception cref="NbtFormatException">
        /// No more tags can be written -OR- a named int array tag was expected -OR- a tag of a different type was expected -OR-
        /// the size of a parent list has been exceeded.
        /// </exception>
        /// <exception cref="ArgumentNullException"><paramref name="data"/>is null</exception>
        ...
        /// <param name="offset">The starting point in <paramref name="data"/>at which to begin writing. Must not be negative.</param>
        /// <param name="count">The number of elements to write. Must not be negative.</param>
        /// <exception cref="NbtFormatException">No more tags can be written -OR- an unnamed int array tag was expected -OR- a tag of a different type was expected.</exception>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="offset"/> or <paramref name="count"/>is negative.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="tagName"/> or <paramref name="data"/>is null</exception>
        /// <exception cref="ArgumentException"><paramref name="count"/> is greater than <paramref name="offset"/>subtracted from the array length.</exception>
