...
namespace Redstone.NBT.Tags
{
    ...
    public sealed class NbtList : NbtTag, IList<NbtTag>, IList
    {
        ...
        public T Get<T>(int tagIndex) where T : NbtTag => (T)tags[tagIndex];
        ...
        bool IList.Contains(object value) => tags.Contains((NbtTag)value);


        int IList.IndexOf(object value) => tags.IndexOf((NbtTag)value);
