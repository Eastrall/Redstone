...
namespace Redstone.NBT.Tags
{
    ...
    public abstract class NbtTag : ICloneable
    {
        ...
        /// If this tag resides in an <c>NbtCompound</c>, and a sibling tag with the name already exists.
        /// </exception>
        public string Name
        {
            get => _name;
        ...
        public static string DefaultIndentString
        {
            ...
            set => _defaultIndentString = value ?? throw new ArgumentNullException("value");
        }
